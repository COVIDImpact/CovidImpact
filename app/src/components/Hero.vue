  ...
  <div class="hero">
    <div class="hero__con">
      ...
      <ul class="hero__con--ul">
        ...
        <li>Our algorithm needs you to provide: Current-Balance, Burn Rate and Monthly Revenue (we’ll take over the rest)</li>
      </ul>
      <svg
